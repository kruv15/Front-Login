    ...
    <main className="min-h-screen bg-gradient-to-b from-white via-[#f9f9f9] to-[#e6e6e6] overflow-x-hidden">
      ...
      <section className="text-center py-20 bg-gradient-to-r from-[#C8102E] to-[#002855] text-white">
        <h1 className="text-4xl font-bold mb-4">
          Bienvenido al entorno virtual de aprendizaje de la UMSS
        </h1>
      ...
      <section className="py-20 bg-gradient-to-b from-[#fefefe] to-[#f2f4f8]">
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-6 text-center px-4">
          <div className="rounded-xl p-6 shadow-md hover:shadow-xl transition bg-gradient-to-b from-[#C8102E] to-[#f8d4d4] text-white">
            ...
            <p>
              Accede a tus materias, recursos educativos, evaluaciones y calificaciones. Mantente al
              día con el calendario académico y comunícate con tus docentes.
            </p>
          </div>
          <div className="rounded-xl p-6 shadow-md hover:shadow-xl transition bg-gradient-to-b from-[#002855] to-[#dce6f7] text-white">
            ...
            <p>
              Gestiona tus materias, sube materiales, crea evaluaciones y califica a tus
              estudiantes. Mantén una comunicación efectiva a través del foro de la materia.
            </p>
          </div>
          <div className="rounded-xl p-6 shadow-md hover:shadow-xl transition bg-gradient-to-b from-[#001a33] to-[#d4deec] text-white">
            ...
            <p>
              Administra usuarios, materias y asignaciones. Accede a reportes y estadísticas para
              tomar decisiones informadas sobre el proceso educativo.
            </p>
          </div>
        </div>
      </section>
      ...
      >
        ...
        <p className="text-gray-700 mb-4">
          El Campus Virtual UMSS es la plataforma educativa oficial de la Universidad Mayor de San
          Simón, diseñada para facilitar el proceso de enseñanza-aprendizaje en un entorno digital
          moderno y accesible.
        </p>
        <p className="text-gray-700 mb-4">
          Nuestra plataforma integra herramientas para la gestión académica, comunicación,
          evaluación y seguimiento del proceso educativo, permitiendo a estudiantes, docentes y
          administradores interactuar de manera eficiente.
        </p>
        <p className="text-gray-700">
          Con un diseño centrado en el usuario, el Campus Virtual UMSS busca mejorar la experiencia
          educativa, facilitando el acceso a recursos y actividades académicas desde cualquier
